...
$(PLT_NAME):
	ERL_LIBS=deps dialyzer --build_plt --output_plt $(PLT_NAME) --apps erts kernel stdlib sasl kvs || true
dialyze: $(PLT_NAME)
	dialyzer ebin --plt $(PLT_NAME) --no_native -Werror_handling -Wunderspecs -Wrace_conditions
tar:
